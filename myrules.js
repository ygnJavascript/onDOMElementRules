window.listenRules=[];
window.newRule=(attr,attrName,code,type="addedNodes")=>{let nextObj={};nextObj.attr=attr;nextObj.attrName=attrName;nextObj.code=code;nextObj.type=type;window.listenRules.push(nextObj);}
